...
class RecipesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recipeAdapter = MealsAdapter(HomePageActivity(), prepareReceiptList())
    ...
    private fun prepareReceiptList(): ArrayList<RecipeModel> {
        ...
        reciepList.add(RecipeModel("Italian pasta",
            "Tasty traditional dish.\nNot only for Italian who went to Malta",
            45,
            4,
            R.drawable.italian_pasta))
        reciepList.add(RecipeModel("Cheese’n’Meat", "Let’s pray only for \nCheesus!", 3, 2,
            R.drawable.cheesen_meat))
        reciepList.add(RecipeModel("Pumpkin Soup",
            "Feel the spiciness and  season vegetables",
            50,
            4,
            R.drawable.pupmpkin_soup))
        reciepList.add(RecipeModel("Asian inspired pasta",
            "Missing pad-thai and living in Italy? Check this out",
            45,
            4,
