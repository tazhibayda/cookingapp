...
import com.example.cookingapp.databinding.CategoryItemBinding
...
class CategoriesAdapter():RecyclerView.Adapter<CategoriesAdapter.CategoryViewHolder>() {
    ...
    Glide.with(holder.itemView).load(categoriesList[position].strCategoryThumb).into(holder.binding.categoryImg)
